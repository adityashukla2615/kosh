...
//
// This is a static import on purpose. An earlier version used createRequire,
// which reads from disk at runtime - fine locally and in the container, but
// esbuild cannot see through it, so the JSON was silently left out of the
// Lambda bundle and AWS would have fallen back to screening on every cold
// start. A static import is bundled, which is what `sam build` is in CI to
// prove.
//
// The file is committed and regenerated by `npm run build`, so it is always
